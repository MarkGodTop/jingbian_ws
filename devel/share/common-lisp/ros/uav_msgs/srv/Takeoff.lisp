...
(cl:defmethod cl:initialize-instance :after ((m <Takeoff-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Takeoff-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uav_msgs-srv:<Takeoff-request> is deprecated: use uav_msgs-srv:Takeoff-request instead.")))

(cl:ensure-generic-function 'waitOnLastTask-val :lambda-list '(m))
(cl:defmethod waitOnLastTask-val ((m <Takeoff-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-srv:waitOnLastTask-val is deprecated.  Use uav_msgs-srv:waitOnLastTask instead.")
  (waitOnLastTask m))
...
(cl:defmethod cl:initialize-instance :after ((m <Takeoff-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Takeoff-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uav_msgs-srv:<Takeoff-response> is deprecated: use uav_msgs-srv:Takeoff-response instead.")))

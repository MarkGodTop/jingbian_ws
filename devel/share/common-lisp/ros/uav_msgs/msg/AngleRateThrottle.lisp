...
(cl:defmethod cl:initialize-instance :after ((m <AngleRateThrottle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AngleRateThrottle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uav_msgs-msg:<AngleRateThrottle> is deprecated: use uav_msgs-msg:AngleRateThrottle instead.")))

(cl:ensure-generic-function 'rollRate-val :lambda-list '(m))
(cl:defmethod rollRate-val ((m <AngleRateThrottle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:rollRate-val is deprecated.  Use uav_msgs-msg:rollRate instead.")
  (rollRate m))

(cl:ensure-generic-function 'pitchRate-val :lambda-list '(m))
(cl:defmethod pitchRate-val ((m <AngleRateThrottle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:pitchRate-val is deprecated.  Use uav_msgs-msg:pitchRate instead.")
  (pitchRate m))

(cl:ensure-generic-function 'yawRate-val :lambda-list '(m))
(cl:defmethod yawRate-val ((m <AngleRateThrottle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:yawRate-val is deprecated.  Use uav_msgs-msg:yawRate instead.")
  (yawRate m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <AngleRateThrottle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:throttle-val is deprecated.  Use uav_msgs-msg:throttle instead.")
  (throttle m))
